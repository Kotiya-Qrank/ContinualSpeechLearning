...
with open("../../IEMOCAP/valid.json")as f:
    IEMOCAP_valid = json.load(f)
    for line in IEMOCAP_valid:
        line["sentence"] = "<|en|><|ER|><|notimestamps|>" + line["sentence"]

half_batch_size = int(batch_size / 2)
new_train = IEMOCAP_train
...
with open("valid.json", 'w', encoding='utf-8') as file:
    file.write(json.dumps(IEMOCAP_valid, indent=4, ensure_ascii=False))
