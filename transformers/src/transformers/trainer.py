        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    ###################################################################
                    # Mask embedding and proj_out
                    if args.mask_embedding:
                        mask_embedding = torch.tensor(args.mask_embedding).cuda()
                        model.model.decoder.embed_tokens.weight.grad *= mask_embedding
                        model.proj_out.weight.grad *= mask_embedding
                    ###################################################################
