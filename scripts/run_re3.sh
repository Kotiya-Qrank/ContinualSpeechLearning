...
CUDA_VISIBLE_DEVICES=3 python whisper_infer.py  --name WSL-00005-KS-SID-ER-IC-SF-ASR-RE  --task RE
CUDA_VISIBLE_DEVICES=3 python whisper_infer.py  --name WSL-00005-KS-SID-ER-IC-SF-ASR-RE  --task transcribe
CUDA_VISIBLE_DEVICES=3 python whisper_infer.py  --name WSL-00005-KS-SID-ER-IC-SF-ASR-RE  --task SF
CUDA_VISIBLE_DEVICES=3 python whisper_infer.py  --name WSL-00005-KS-SID-ER-IC-SF-ASR-RE  --task IC
CUDA_VISIBLE_DEVICES=3 python whisper_infer.py  --name WSL-00005-KS-SID-ER-IC-SF-ASR-RE  --task ER
CUDA_VISIBLE_DEVICES=3 python whisper_infer.py  --name WSL-00005-KS-SID-ER-IC-SF-ASR-RE  --task SID
CUDA_VISIBLE_DEVICES=3 python whisper_infer.py  --name WSL-00005-KS-SID-ER-IC-SF-ASR-RE  --task KS
