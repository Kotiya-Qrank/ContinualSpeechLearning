...
#CUDA_VISIBLE_DEVICES=0 python whisper_finetune_cl.py>>/datanfs2/wgt/TransformersWhisper/logs8/PW-WSL-1-KS-SID-ER-IC-SF-ASR-RE.log  --name PW-WSL-1-KS-SID-ER-IC-SF-ASR-RE  --task NONE   --dataset continual_task/KS-SID-ER-IC-SF-ASR-RE  --base_model /datanfs2/wgt/TransformersWhisper/output4/whisper-base/PW-WSL-1-KS-SID-ER-IC-SF-ASR_00001  --temperature 1  --freeze_weights True
#CUDA_VISIBLE_DEVICES=0 python whisper_infer.py  --name PW-WSL-1-KS-SID-ER-IC-SF-ASR-RE  --task RE
#CUDA_VISIBLE_DEVICES=0 python whisper_infer.py  --name PW-WSL-1-KS-SID-ER-IC-SF-ASR-RE  --task transcribe
#CUDA_VISIBLE_DEVICES=0 python whisper_infer.py  --name PW-WSL-1-KS-SID-ER-IC-SF-ASR-RE  --task SF
#CUDA_VISIBLE_DEVICES=0 python whisper_infer.py  --name PW-WSL-1-KS-SID-ER-IC-SF-ASR-RE  --task IC
#CUDA_VISIBLE_DEVICES=0 python whisper_infer.py  --name PW-WSL-1-KS-SID-ER-IC-SF-ASR-RE  --task ER
#CUDA_VISIBLE_DEVICES=0 python whisper_infer.py  --name PW-WSL-1-KS-SID-ER-IC-SF-ASR-RE  --task SID
#CUDA_VISIBLE_DEVICES=0 python whisper_infer.py  --name PW-WSL-1-KS-SID-ER-IC-SF-ASR-RE  --task KS
...
#CUDA_VISIBLE_DEVICES=3 python whisper_infer.py  --name Replay-KS-SID-ER-IC-SF-ASR-RE  --task RE
CUDA_VISIBLE_DEVICES=3 python whisper_infer.py  --name DERPP-PW-WSL-1-KS-SID-ER-IC-SF-ASR-RE  --task transcribe
CUDA_VISIBLE_DEVICES=3 python whisper_infer.py  --name DERPP-PW-WSL-1-KS-SID-ER-IC-SF-ASR-RE  --task SF
CUDA_VISIBLE_DEVICES=3 python whisper_infer.py  --name DERPP-PW-WSL-1-KS-SID-ER-IC-SF-ASR-RE  --task IC
CUDA_VISIBLE_DEVICES=3 python whisper_infer.py  --name DERPP-PW-WSL-1-KS-SID-ER-IC-SF-ASR-RE  --task ER
CUDA_VISIBLE_DEVICES=3 python whisper_infer.py  --name DERPP-PW-WSL-1-KS-SID-ER-IC-SF-ASR-RE  --task SID
CUDA_VISIBLE_DEVICES=3 python whisper_infer.py  --name DERPP-PW-WSL-1-KS-SID-ER-IC-SF-ASR-RE  --task KS
